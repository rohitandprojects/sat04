          ...
          <article id="panel-2" className="panel gray">
            <div className="cards-wrapper">
              {post?.pouch && post?.pouch.length > 0 && post?.pouch.map((imgSrc,index) => {
               ...
               return <div className="sku-card" key={imgSrc}><div className="sku-icon"><img src={`/images/${imgSrc}`} alt={title}/></div></div>
              })}
    ...
    <section className="section cs-section min-height100 d-flex align-items-center">
              ...
              <div className="col-lg-6 col-md-6 col-sm-6 btmToTp2">
								<div className="row">
									<div className="col-lg-7 col-md-7 col-sm-7">
										<div className="c-specification-icon"><img src={`/images/${post?.container[0]}`} className="w-100 h-auto" alt=""/></div>
									</div>
            ...
            {post?.container[1] &&
              <div className="col-lg-6 col-md-6 col-sm-6 btmToTp2">
								<div className="row">
									<div className="col-lg-7 col-md-7 col-sm-7">
										<div className="c-specification-icon"><img src={`/images/${post?.container[1]}`} className="w-100 h-auto" alt=""/></div>
									</div>
									<div className="col-lg-5 col-md-5 col-sm-5">
										<div className="c-specification-dtl">
											<h3>Quantity:</h3>
