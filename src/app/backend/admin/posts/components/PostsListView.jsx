                    ...
                    <td className="packaging">
                        ...
                        <div className="packaging-wrap">
                            <div className="packaging-row">
                                ...
                                return <div className="packaging-card" data-key={item?.id+imgSrc+index} key={item?.id+imgSrc+index}><div className="sku-icon"><img src={`/images/${imgSrc}`} alt={title}/></div><h4>{title}</h4></div>
                                })}
                            </div>
                            <div className="packaging-row">
