                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU5gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-5-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>5 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU7gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-7-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>7 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU10gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-10-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>10 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU12gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-12-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>12 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU15gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-15-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>15 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU20gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-20-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>20 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU30gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-30-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>30 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU40gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-40-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>40 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU50gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-50-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>50 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU100gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-100-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>100 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU200gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-200-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>200 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU200Plus200gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-200+200-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>200+200 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU500gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-500-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>500 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU1000gmsPouch">
                                            <div className="sku-holder"><img src={'/images/sku-1000-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>1000 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU1kgPouch">
                                            <div className="sku-holder"><img src={'/images/sku-1kg-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>1 KG</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU1kgB2Bpouch">
                                            <div className="sku-holder"><img src={'/images/sku-1kg-B2B-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>1 KG B2B</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU5kgouch">
                                            <div className="sku-holder"><img src={'/images/sku-5kg-Pouch.svg'} alt="Pouch" /></div>
                                            <h4>1 KG</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU15Box">
                                            <div className="sku-holder"><img src={'/images/sku-box-15gm.svg'} alt="box" /></div>
                                            <h4>15 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU20Box">
                                            <div className="sku-holder"><img src={'/images/sku-box-20gm.svg'} alt="box" /></div>
                                            <h4>20 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU50Box">
                                            <div className="sku-holder"><img src={'/images/sku-box-50gm.svg'} alt="box" /></div>
                                            <h4>50 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU60Box">
                                            <div className="sku-holder"><img src={'/images/sku-box-60gm.svg'} alt="box" /></div>
                                            <h4>60 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU100Box">
                                            <div className="sku-holder"><img src={'/images/sku-box-100gm.svg'} alt="box" /></div>
                                            <h4>100 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU175Plus175Box">
                                            <div className="sku-holder"><img src={'/images/sku-box-175+175gm.svg'} alt="box" /></div>
                                            <h4>175+175 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU200Box">
                                            <div className="sku-holder"><img src={'/images/sku-box-200gm.svg'} alt="box" /></div>
                                            <h4>200 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU500Box">
                                            <div className="sku-holder"><img src={'/images/sku-box-500gm.svg'} alt="box" /></div>
                                            <h4>500 Grams</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU01gmsJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-01gms.svg'} alt="jar" /></div>
                                            <h4>01 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU05gmsJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-05gms.svg'} alt="jar" /></div>
                                            <h4>0.5 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU10gmsJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-10gms.svg'} alt="jar" /></div>
                                            <h4>10 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU20gmsJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-20gms.svg'} alt="jar" /></div>
                                            <h4>20 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU25gmsJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-25gms.svg'} alt="jar" /></div>
                                            <h4>25 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU200gmsJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-200gms.svg'} alt="jar" /></div>
                                            <h4>200 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU250gmsJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-250gms.svg'} alt="jar" /></div>
                                            <h4>250 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU500gmsJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-500gms.svg'} alt="jar" /></div>
                                            <h4>500 GMS</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU1kgJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-1kg.svg'} alt="jar" /></div>
                                            <h4>1 KG</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-3">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU1kgB2BJar">
                                            <div className="sku-holder"><img src={'/images/sku-jar-1kgb2b.svg'} alt="jar" /></div>
                                            <h4>1 KG</h4>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div className="col-6">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU22MetricTonne">
                                            <div className="sku-holder"><img src={'/images/container-small.svg'} alt="container" /></div>
                            ...
                            <div className="col-6">
                                <div className="sku-card">
                                    <div className="form-check">
                                        ...
                                        <label className="form-check-label" for="SKU26MetricTonne">
                                            <div className="sku-holder"><img src={'/images/container-large.svg'} alt="container" /></div>
